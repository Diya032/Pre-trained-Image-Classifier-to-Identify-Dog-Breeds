...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_breed'] = 0  # Handling Key error observed during compilation
    ...
    for key in results_dic:
        ...
        # labels match --> 1 pet label-> is a dog(1) classifier label --> is a dog(1) ; SUM(1+1+1)
    ...
    # Calculates % correct dogs , Handling Zero Division error encountered with conditionals 
